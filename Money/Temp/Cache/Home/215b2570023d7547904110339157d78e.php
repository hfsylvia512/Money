...
<body>
    <!-- header -->
    <header class="mui-bar2 hnav" style="background:#7457ea;box-shadow: none;">
	</header>
	<!-- header end-->
	...
	<div class="maotop">
		<div class="hedpic">
			<a href="<?php echo U('User/login');?>">
				<img src="__PUBLIC__/home/imgs/photo.png" alt="">
			</a>
	    				...
	    				<div class="input-group">
							<div class="cf kuren">
								<div class="fl kuai hsma">
							    	<img src="__PUBLIC__/home/imgs/tixian.png" alt="">
							    </div>
							    <div class="fl mname">      
							    	<p>可提现余额: <soan style="color:red"><?php echo ($money); ?></soan>元</p>
							    </div>
	    		...
	    		<div class="inpifo">
	    			<a href="<?php echo U('Info/index');?>">
	    				<div class="input-group">
							<div class="cf kuren">
								<div class="fl kuai hsma">
							    	<img src="__PUBLIC__/home/imgs/wdzl.png" alt="">
							    </div>
							    <div class="fl mname">      
							    	<p>我的资料</p>
							    </div>
						...
						<div class="input-group">
							<div class="cf kuren">
								<div class="fl hsma kuai">
							    	<img src="__PUBLIC__/home/imgs/wdjk.png" alt="">
							    </div>
							    <div class="fl mname">      
							    	<p>我的借款</p>
							    </div>
	    		...
	    		<div class="inpifo">
					<a href="<?php echo U('Order/bills');?>">
						<div class="input-group">
							<div class="cf kuren">
								<div class="fl hsma kuai">
							    	<img src="__PUBLIC__/home/imgs/wdhk.png" alt="">
							    </div>
							    <div class="fl mname">      
							    	<p>我的还款</p>
							    </div>
		    	...
		    	<div class="inpifo">
					<a href="<?php echo U('Help/index');?>">
						...
						<div class="input-group">
							<div class="cf kuren">
								<div class="fl hsma kuai">
							    	<img src="__PUBLIC__/home/imgs/kefu.png" alt="">
							    </div>
							    <div class="fl mname">      
							    	<p>客服</p>
							    </div>
	    		...
	    		<!-- <div class="inpifo">
					<a href="<?php echo U('Fenxiao/index');?>">
						<div class="input-group">
							<div class="cf kuren">
								<div class="fl hsma kuai">
							    	<img src="__PUBLIC__/home/imgs/wechat.png" alt="">
							    </div>
							    <div class="fl mname">      
							    	<p>我的分销</p>
							    </div>
    		...
    		<div class="inpifo">
				<a href="<?php echo U('User/backpwd');?>">
					<div class="input-group">
						<div class="cf kuren">
							<div class="fl hsma kuai">
						    	<img src="__PUBLIC__/home/imgs/xmm.png" alt="">
						    </div>
						    <div class="fl mname">      
						    	<p>修改密码&nbsp;</p>
						    </div>
    		...
    		<div class="inpifo">
				<a href="javascript:logout();">
					<div class="input-group">
						<div class="cf kuren">
							<div class="fl hsma kuai">
						    	<img src="__PUBLIC__/home/imgs/tcdl.png" alt="">
						    </div>
						    <div class="fl mname">      
						    	<p>退出登录</p>
						    </div>
   ...
   <!-- bottom bar -->
    <nav class="mui-bar mui-bar-tab bottom-bar">
        <a class="mui-tab-item" href="<?php echo U('Index/index');?>">
            <span class="mui-icon ">
            	<img src="__PUBLIC__/home/imgs/home2.png" style="width: 100%">
        	</span>
        ...
        <a class="mui-tab-item cur" href="<?php echo U('User/index');?>">
            <span class="mui-icon cur">
            	<img src="__PUBLIC__/home/imgs/me.png" style="width: 100%">
            </span>
