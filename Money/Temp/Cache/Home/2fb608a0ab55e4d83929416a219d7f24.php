 ...
 $name = "补充资料说明"; $Block = D("block"); $blockinfo = $Block->where(array('name' => $name))->find(); if(empty($blockinfo)){ echo ""; }else{ echo $blockinfo['cont']; } ?>
		...
		<article class="cominfo">
			<div class="container">
	    		...
	    		<div class="inpifo">
					<div class="input-group">
						<div class="cf kuren">
						    ...
						    <div class="fl">
						    	<p class="datatip">请上传其他收入或财务证明
</p>
						    	<p class="f14 col9">(如：房产证 行驶证 工资证明 公积金 医保)</p>
						    </div>
					    </div>
		    		</div>
		    	</div>
	    		...
	    		<!-- 右箭头 -->
	    		<!-- <a id='zhima1'  href="<?php echo U('Info/zhima');?>" class="wrapline">
	    		<div class="inpifo">
					<div class="input-group">
						<div class="cf kuren">
							<div class="fl sma sma2">
	    		...
	    		<!-- 右箭头 -->
	    		<!-- <a id='zhima1'  href="<?php echo U('Info/taobao');?>" class="wrapline">
	    		<div class="inpifo">
					<div class="input-group">
						<div class="cf kuren">
							<div class="fl sma sma2">
						    	<img src="__PUBLIC__/home/imgs/taobao.jpg" alt="">
						    </div>
						    <div class="fl">
						    ...
						    <div class="fr pr">
							    <div class="selar moren">
							    	<?php if($info['taobaoinfo'] == 1): ?><span class="col9">已授权</span>
							    	<?php else: ?>
							    	<span class="col9">未授权</span><?php endif; ?>
							    	<span class="seltarr1"></span>
							    </div>
					    	</div>
					    </div>
